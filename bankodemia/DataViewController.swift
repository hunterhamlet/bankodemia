...
class DataViewController: BaseUIViewController {
    ...
    private func initUI() {
        ...
        lExample2.text = StringSP.headDataText
        ...
        lExample.text = StringSP.bottomDataText
        lExample.applyDarkStyle(fontSize: FontSize.size18)
        lExample.numberOfLines = .zero
        lExample.addAnchorsAndSize(width: nil, height: Dimensions.tilHeight, left: Dimensions.grid8, top: nil, right:Dimensions.grid8, bottom: 130, withAnchor: nil, relativeToView: btContained)
